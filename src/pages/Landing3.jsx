...
function RankBadge({ score }) {
  ...
  return (
    <span className={`badge ${tier.colorClass}`} style={{ fontSize: '1rem' }}>
      {tier.icon} {tier.name}
    </span>
  );
}
  ...
  if (joined) {
    return (
      <div style={{
        ...
        background: 'rgba(16,124,16,0.06)', border: '1px solid rgba(0,229,160,0.25)', borderRadius: 12,
      }}>
        <span style={{ fontSize: '1.5rem' }}>🎉</span>
        <div>
          <div style={{ fontWeight: 700, color: '#107c10', fontSize: '1.05rem' }}>You're on the list!</div>
          <div style={{ fontSize: '1.05rem', color: '#484848' }}>We'll notify you at {email}</div>
        </div>
      </div>
    );
  }
    ...
    <form onSubmit={handle} className="waitlist-form-row">
      <input
        ...
        style={{
          ...
          ...(error ? { borderColor: '#a4262c' } : {}),
        }}
      />
      <button type="submit" className={`btn ${variant === 'hero' ? 'btn-gold btn-lg' : 'btn-primary'}`}>
        {variant === 'hero' ? '🚀 Join the Waitlist' : 'Get Early Access'}
      </button>
      {error && <div style={{ width: '100%', fontSize: '1.05rem', color: '#a4262c' }}>{error}</div>}
    </form>
  );
}
...
export default function Landing3({ onNavigate }) {
  ...
  return (
    <div>
          ...
          <div className="hero-grid">
            ...
            <div>
              ...
              <p className="stagger-2" style={{
                fontSize: '1.15rem', color: '#484848', lineHeight: 1.75,
              ...
              <div className="stagger-4 hero-stats">
                {[
                  ...
                  <div key={val}>
                    ...
                    <div style={{ fontSize: '1rem', color: '#616161', fontWeight: 500 }}>{label}</div>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="stagger-2 hero-right">
                        ...
                        >
                          ...
                          >
                            ...
                            <div style={{
                              ...
                              background: isGold ? 'linear-gradient(135deg, #ffc83c, #ff8c00)' : 'linear-gradient(135deg, #0067b8, #004e8c)',
                              display: 'flex', alignItems: 'center', justifyContent: 'center',
                              fontWeight: 700, fontSize: isGold ? '1.1rem' : '0.9rem',
                              color: '#fff',
                              border: isGold ? '2px solid rgba(255,200,60,0.6)' : '2px solid rgba(0,103,184,0.4)',
                              boxShadow: isGold ? '0 0 20px rgba(255,200,60,0.35)' : 'none',
                            }}>{(u.name || '?')[0]}</div>
                            {/* Name */}
                            <div style={{ fontSize: isGold ? '1rem' : '0.92rem', fontWeight: 700, color: isGold ? '#742774' : '#242424', lineHeight: 1 }}>
                              {u.name.split(' ')[0]}
                            </div>
                            {/* Score */}
              ...
              <div className="card" style={{ padding: 0, overflow: 'hidden' }}>
                {[...preview].sort((a, b) => b.score - a.score).slice(3).map((u, i) => (
                  <div
                    ...
                    style={{
                      ...
                      borderBottom: i < preview.slice(3).length - 1 ? '1px solid rgba(0,0,0,0.09)' : 'none',
                  ...
                  >
                    ...
                    <div style={{
                      ...
                      background: '#dde4ed',
                      display: 'flex', alignItems: 'center', justifyContent: 'center',
                      fontSize: '1rem', fontWeight: 700, color: '#242424',
                    }}>{(u.name || '?')[0]}</div>
                    <div style={{ flex: 1, minWidth: 0 }}>
                      <div style={{ fontSize: '1.05rem', fontWeight: 600, color: '#242424', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>{u.name}</div>
                ...
                <div style={{ padding: '0.75rem 1rem', borderTop: '1px solid rgba(0,0,0,0.08)', textAlign: 'center' }}>
      ...
      {/* ─── THE PROBLEM ─────────────────────────────────── */}
      <section className="section-alt" style={{ padding: '5rem 0', background: '#f2f2f2', borderTop: '1px solid rgba(0,0,0,0.08)', borderBottom: '1px solid rgba(0,0,0,0.08)' }}>
        <div className="container-sm" style={{ textAlign: 'center' }}>
          ...
          <p style={{ fontSize: '1.1rem', color: '#484848', lineHeight: 1.8, maxWidth: 640, margin: '0 auto 2.5rem' }}>
          ...
          <div className="grid-3">
            {[
              ...
              <div key={s.stat} className="card" style={{ textAlign: 'center', padding: '2rem 1.5rem' }}>
                ...
                <div style={{ fontFamily: 'Rajdhani', fontWeight: 700, fontSize: '2rem', color: '#742774', marginBottom: '0.5rem' }}>{s.stat}</div>
                <p style={{ color: '#484848', fontSize: '1.05rem', lineHeight: 1.65, margin: 0 }}>{s.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section style={{ padding: '5rem 0' }}>
        <div className="container">
          <div style={{ textAlign: 'center', marginBottom: '3.5rem' }}>
            ...
            <p style={{ color: '#484848', fontSize: '1.05rem', maxWidth: 560, margin: '0 auto' }}>
            ...
            {[
              {
                ...
                color: '#0067b8', borderColor: 'rgba(0,103,184,0.25)',
              },
              {
                ...
                color: '#107c10', borderColor: 'rgba(0,229,160,0.25)',
              },
              {
                ...
                color: '#742774', borderColor: 'rgba(167,139,250,0.25)',
              },
              {
                ...
                color: '#742774', borderColor: 'rgba(116,39,116,0.2)',
              },
              {
                ...
                color: '#d83b01', borderColor: 'rgba(251,146,60,0.25)',
              },
              {
                ...
                color: '#0099bc', borderColor: 'rgba(0,229,255,0.2)',
              },
            ].map(f => (
              <div
                key={f.num}
      ...
      {/* ─── RANK TIERS ──────────────────────────────────── */}
      <section className="section-alt" style={{ padding: '4.5rem 0', background: '#f2f2f2', borderTop: '1px solid rgba(0,0,0,0.08)', borderBottom: '1px solid rgba(0,0,0,0.08)' }}>
        <div className="container">
          <div style={{ textAlign: 'center', marginBottom: '2.5rem' }}>
            ...
            <p style={{ color: '#484848', marginTop: '0.75rem' }}>Five tiers. Transparent thresholds. No politics.</p>
          </div>
            ...
            {RANK_TIERS.map((tier, i) => (
              <div key={tier.name} style={{
                ...
                background: i === 4
                  ...
                  : '#ffffff',
                border: `1px solid ${i === 4 ? 'rgba(255,200,60,0.3)' : 'rgba(0,0,0,0.09)'}`,
                borderRadius: 16,
      ...
      <section style={{ padding: '4.5rem 0' }}>
        <div className="container">
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.85rem', justifyContent: 'center' }}>
            {[
              { name: 'Dynamics 365',   icon: '📦', color: '#0067b8',   glow: 'rgba(0,194,255,0.12)',   count: '12 certs' },
              { name: 'Power Platform', icon: '⚡', color: '#742774', glow: 'rgba(167,139,250,0.1)',  count: '10 certs' },
              { name: 'Copilot Studio', icon: '🤖', color: '#a4262c',   glow: 'rgba(244,114,182,0.1)',  count: '6 certs + 1.25× bonus', hot: true },
              { name: 'Azure OpenAI',   icon: '🧠', color: '#0099bc',   glow: 'rgba(0,229,255,0.1)',    count: '9 certs' },
              { name: 'Dataverse',      icon: '🗄️', color: '#107c10',  glow: 'rgba(0,229,160,0.1)',   count: 'Composite score' },
              { name: 'Power Apps',     icon: '📱', color: '#d83b01', glow: 'rgba(251,146,60,0.1)',  count: '5 certs' },
            ].map(s => (
              ...
              onMouseLeave={e => { e.currentTarget.style.transform = ''; e.currentTarget.style.borderColor = 'rgba(0,0,0,0.09)'; }}
              onClick={() => onNavigate('scoring')}
              >
                <span style={{ fontSize: '1.3rem' }}>{s.icon}</span>
                <div>
                  <div style={{ fontWeight: 700, fontSize: '1rem', color: s.color }}>{s.name}</div>
                  <div style={{ fontSize: '1.05rem', color: '#616161' }}>{s.count}</div>
                </div>
                {s.hot && <span className="badge badge-gold" style={{ fontSize: '1.05rem', padding: '0.1rem 0.45rem', marginLeft: '0.25rem' }}>HOT</span>}
              </div>
            ))}
          </div>
            ...
            {[
              ...
              <div key={p.title} className="card" style={{ borderTop: `3px solid ${p.color}`, padding: '2rem' }}>
                ...
                <ul style={{ margin: 0, padding: 0, listStyle: 'none', display: 'flex', flexDirection: 'column', gap: '0.6rem' }}>
                  {p.points.map(pt => (
                    <li key={pt} style={{ display: 'flex', gap: '0.6rem', fontSize: '1rem', color: '#484848', lineHeight: 1.55 }}>
            ...
            {[
              ...
              <div key={s.n} className="card" style={{
                ...
                <div style={{ paddingTop: '0.25rem' }}>
                  ...
                  <p style={{ color: '#484848', fontSize: '1rem', lineHeight: 1.65, margin: 0 }}>{s.desc}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      {/* ─── SCORING FORMULA ─────────────────────────────── */}
      <section className="section-alt" style={{ padding: '5.5rem 0', background: '#f2f2f2', borderTop: '1px solid rgba(0,0,0,0.08)', borderBottom: '1px solid rgba(0,0,0,0.08)' }}>
        <div className="container">
          ...
          <p style={{ fontSize: '1rem', color: '#484848', lineHeight: 1.7, maxWidth: 520, marginBottom: '3rem' }}>
          ...
          <div className="scoring-grid-b">
            ...
            <div>
              ...
              <div className="formula-eq">
                <span style={{ color: '#0067b8' }}>StackRank Score</span>
                {' '}<span style={{ color: '#742774' }}>=</span><br />
                &nbsp;&nbsp;(<span style={{ color: '#0067b8' }}>Certifications</span>
                {' '}<span style={{ color: '#742774' }}>×</span> level_weight)<br />
                <span style={{ color: '#742774' }}>+</span> (<span style={{ color: '#0067b8' }}>Verified Projects</span>
                {' '}<span style={{ color: '#742774' }}>×</span> scale_weight)<br />
                <span style={{ color: '#742774' }}>+</span> (<span style={{ color: '#0067b8' }}>Community Actions</span>
                {' '}<span style={{ color: '#742774' }}>×</span> trust_weight)<br />
                <span style={{ color: '#742774' }}>+</span> (<span style={{ color: '#0067b8' }}>Prestige Bonuses</span>
                {' '}<span style={{ color: '#742774' }}>×</span> 1.0)<br />
                <span style={{ color: '#742774', display: 'block', marginTop: '0.25rem' }}>──────────────────────</span>
                <span style={{ color: '#107c10', fontWeight: 500 }}>= Your Global Stack Rank</span>
              </div>

              <p style={{ fontSize: '1.05rem', lineHeight: 1.75, color: '#484848', marginBottom: '1.5rem' }}>
                <strong style={{ color: '#242424' }}>Why we show the formula.</strong> Most ranking systems are black boxes. We believe
              ...
              <div style={{ padding: '1.1rem 1.4rem', background: 'rgba(0,103,184,0.06)', border: '1px solid rgba(0,103,184,0.2)', borderRadius: 8 }}>
                ...
                <div style={{ fontFamily: 'Rajdhani', fontWeight: 700, fontSize: '1.4rem', color: '#742774' }}>
            ...
            <div className="card" style={{ padding: 0, overflow: 'hidden', border: '1px solid rgba(0,103,184,0.2)' }}>
              <div style={{
              ...
              <div style={{ padding: '0 1.5rem' }}>
                {[
                  { name: 'Sign Up + Complete Profile',      weight: 'Founding',    pts: '500 pts',   color: '#107c10'  },
                  { name: 'Fundamentals Certification',      weight: '×1.0',        pts: '500 pts',   color: '#484848' },
                  { name: 'Associate Certification',         weight: '×1.5',        pts: '1,500 pts', color: '#0067b8'   },
                  { name: 'Expert / Specialty Cert',        weight: '×3.0',        pts: '3,000 pts', color: '#742774'   },
                  { name: 'Applied Skills Credential',      weight: '×0.4',        pts: '400 pts',   color: '#107c10'  },
                  { name: 'Validated Project (Std)',         weight: '×0.8',        pts: '800 pts',   color: '#0067b8'   },
                  { name: 'Validated Project (Enterprise)', weight: '×2.0',        pts: '2,000 pts', color: '#742774' },
                  { name: 'Copilot Studio certs',           weight: '1.25× bonus', pts: 'Scarcity',  color: '#a4262c'   },
                  { name: 'Microsoft MVP',                  weight: 'Prestige',    pts: '1,500 pts', color: '#742774'   },
                  { name: 'Peer Referral (both join)',      weight: '×0.5',        pts: '500 pts',   color: '#484848' },
                ].map((row, i, arr) => (
                  <div key={row.name} className="pts-row" style={{
                    borderBottom: i < arr.length - 1 ? '1px solid rgba(0,0,0,0.09)' : 'none',
                  }}>
      ...
      <section style={{ padding: '5.5rem 0', borderBottom: '1px solid rgba(0,0,0,0.08)' }}>
        <div className="container">
          ...
          <div className="rankings-grid-b">
            ...
            <div className="card" style={{ padding: 0, overflow: 'hidden' }}>
              ...
              {[
                ...
                { initials: 'MR', name: 'Marcus R.', tags: [{ label: 'PL-400', c: '#0067b8'   }, { label: 'AI-102', c: '#742774' }], pts: 8415,  bg: 'linear-gradient(135deg,#107c10,#0078d4)', rank: 1 },
                { initials: 'PL', name: 'Priya L.',  tags: [{ label: 'PL-200', c: '#0067b8'   }, { label: 'Expert', c: '#742774'   }], pts: 7720,  bg: 'linear-gradient(135deg,#c8a84b,#d13438)', rank: 2 },
                { initials: 'JT', name: 'James T.',  tags: [{ label: 'PL-400', c: '#0067b8'   }],                                         pts: 6230,  bg: 'linear-gradient(135deg,#486860,#0078d4)', rank: 3 },
                { initials: 'AN', name: 'Aisha N.',  tags: [{ label: 'PL-600', c: '#742774' }],                                         pts: 5890,  bg: 'linear-gradient(135deg,#5c2d91,#c8a84b)', rank: 4 },
              ].map((row, i) => {
                const medals = ['🥇', '🥈', '🥉'];
              ...
              {/* Projected rank row */}
              <div className="proj-rank-row" style={{ background: 'rgba(0,103,184,0.06)', border: '1px solid rgba(0,103,184,0.2)', borderRadius: 8, padding: '1rem 1.4rem', margin: '1rem' }}>
                <div style={{ fontSize: '1.05rem', color: '#484848', lineHeight: 1.5 }}>
                  Your projected rank after signup + 2 certs + 1 project:<br />
                  <strong style={{ color: '#242424', fontFamily: 'Rajdhani', fontSize: '1rem', fontWeight: 700 }}>~ #8 Power Platform · UK</strong>
                </div>
      ...
      {/* ─── DEMO CTA ────────────────────────────────────── */}
      <section className="section-alt" style={{ padding: '3rem 0', background: '#f2f2f2', borderTop: '1px solid rgba(0,0,0,0.08)', borderBottom: '1px solid rgba(0,0,0,0.08)' }}>
        <div className="container">
          <div style={{ display: 'flex', gap: '1rem', overflowX: 'auto', paddingBottom: '0.5rem', justifyContent: 'center' }}>
            {[
              { label: 'Live Leaderboard', desc: 'See 15 sample professionals ranked', btn: 'View Rankings', page: 'leaderboard', color: '#0067b8' },
              { label: 'Sample Profile',   desc: 'Explore a detailed pro profile',    btn: 'Browse Profile', page: 'profile', profileUser: SAMPLE_USERS[0], color: '#742774' },
              { label: 'Full Scoring',     desc: '35+ certs explained with point values', btn: 'See the Math', page: 'scoring', color: '#742774' },
            ].map(d => (
              <div key={d.label} className="card" style={{ flex: '1 0 220px', maxWidth: 300, borderTop: `3px solid ${d.color}`, textAlign: 'center', padding: '1.5rem' }}>
                ...
                <p style={{ color: '#484848', fontSize: '0.93rem', marginBottom: '1.1rem' }}>{d.desc}</p>
                <button
      ...
      <section className="cta-final-section" style={{
        ...
        <div className="container" style={{ textAlign: 'center', maxWidth: 680, margin: '0 auto' }}>
          ...
          <p style={{ color: 'rgba(255,255,255,0.88)', fontSize: '1.1rem', lineHeight: 1.75, marginBottom: '2.5rem' }}>
            StackRank365 is in early access. Founding members earn <strong style={{ color: '#fff' }}>500 bonus Stack Points</strong> — 
          ...
          <p style={{ fontSize: '1.05rem', color: 'rgba(255,255,255,0.65)', marginTop: '1rem' }}>
