                ...
                return (
                  ...
                  >
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginTop: '0.2rem' }}>
                      ...
                      <span style={{ fontFamily: 'Poppins', fontWeight: 700, fontSize: '1.1rem', color: medalColors[i] || 'var(--text)' }}>
                  ...
                  return (
                    ...
                    >
                      <td style={{ paddingLeft: '1.25rem' }}>
                        <span style={{ fontFamily: 'Poppins', fontSize: '0.78rem', color: 'var(--muted)' }}>{rank}</span>
                      </td>
                      <td>
                        <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
                      ...
                      <td style={{ textAlign: 'right', paddingRight: '1.25rem' }}>
                        <span style={{ fontFamily: 'Poppins', fontWeight: 700, fontSize: '0.9rem', color: isMe ? 'var(--gold)' : 'var(--blue)' }}>
                          {u.score.toLocaleString()}
                        </span>
                      </td>
                    </tr>
