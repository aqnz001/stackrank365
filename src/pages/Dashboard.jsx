          ...
          {filtered.map(cert => (
            <div key={cert.code} onClick={() => setSelected(cert)} style={{
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                ...
                <div style={{ fontSize: '0.72rem', color: 'var(--muted)', fontFamily: 'Poppins' }}>{cert.code} · {cert.specialization}</div>
              </div>
              <span className={`badge ${tierColors[cert.tier]}`} style={{ fontSize: '0.68rem', flexShrink: 0 }}>{cert.tier}</span>
              <span style={{ fontFamily: 'Poppins', fontSize: '0.78rem', color: 'var(--green)', flexShrink: 0 }}>+{cert.points}</span>
            </div>
          ))}
            ...
            {unverified.map((cert, i) => (
              <div key={i} className="card" style={{ padding: '0.85rem 1.1rem', display: 'flex', alignItems: 'center', gap: '0.75rem', borderLeft: '3px solid var(--gold)' }}>
                ...
                <div style={{ flex: 1 }}>
                  ...
                  <div style={{ fontSize: '0.72rem', color: 'var(--muted)', fontFamily: 'Poppins' }}>{cert.code}</div>
                </div>
  ...
  return (
    <div className="card" style={{ padding: '1rem', marginBottom: '1.25rem' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '0.4rem' }}>
        ...
        <span style={{ fontFamily: 'Poppins', fontSize: '0.82rem', color: 'var(--blue)', fontWeight: 700 }}>{pct}%</span>
      </div>
              ...
              {[
                ...
                <div key={item.label} style={{ marginBottom: '1rem' }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '0.3rem' }}>
                    ...
                    <span style={{ fontFamily: 'Poppins', fontSize: '0.8rem', color: item.color }}>{item.pts.toLocaleString()} pts</span>
                  </div>
                  ...
                  <div key={i} className="card" style={{ padding: '1rem 1.25rem', display: 'flex', alignItems: 'center', gap: '1rem', borderLeft: `3px solid ${cert.verified ? 'var(--green)' : 'var(--gold)'}` }}>
                    ...
                    <div style={{ flex: 1, minWidth: 0 }}>
                      ...
                      <div style={{ display: 'flex', gap: '0.5rem', alignItems: 'center', marginTop: '0.25rem', flexWrap: 'wrap' }}>
                        <span style={{ fontFamily: 'Poppins', fontSize: '0.72rem', color: 'var(--muted)' }}>{cert.code}</span>
                    ...
                    <span style={{ fontFamily: 'Poppins', fontWeight: 700, color: cert.verified ? 'var(--green)' : 'var(--muted)', fontSize: '0.9rem', flexShrink: 0 }}>
                  ...
                  <div key={proj.id} className="card" style={{ padding: '1.25rem' }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: '1rem', flexWrap: 'wrap' }}>
                      ...
                      <div style={{ display: 'flex', gap: '0.5rem', alignItems: 'center', flexWrap: 'wrap' }}>
                        <span style={{ fontFamily: 'Poppins', fontWeight: 700, color: 'var(--blue)', fontSize: '0.85rem' }}>+{(proj.enterprise ? 2000 : 800).toLocaleString()}</span>
                        {!proj.validated && (
              ...
              return (
                <div className="card" style={{ padding: '1rem', marginBottom: '1.25rem' }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '0.4rem' }}>
                    ...
                    <span style={{ fontFamily: 'Poppins', fontSize: '0.82rem', color: 'var(--gold)', fontWeight: 700 }}>{applied.toLocaleString()} / {cap.toLocaleString()} pts cap</span>
                  </div>
                  <div style={{ height: 6, background: 'var(--surface)', borderRadius: 99, overflow: 'hidden', marginBottom: '0.4rem' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '0.3rem' }}>
                {[
                  ...
                  <div key={item.label} style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', fontSize: '0.8rem' }}>
                    ...
                    <span style={{ fontFamily: 'Poppins', color: 'var(--green)', fontWeight: 700 }}>{item.pts}</span>
                ...
                {communityItems.map(item => (
                  <div key={item.id} className="card" style={{ padding: '1rem', display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: '1rem' }}>
                    ...
                    <div style={{ textAlign: 'right', flexShrink: 0 }}>
                      <div style={{ fontFamily: 'Poppins', color: 'var(--gold)', fontWeight: 700 }}>+{(item.points_awarded||0).toLocaleString()}</div>
          ...
          <div style={{ maxWidth: 600 }}>
            ...
            <div className="card" style={{ marginTop: '1rem' }}>
              ...
              {(() => {
                ...
                return (
                  <div style={{ display: 'flex', gap: '0.5rem', alignItems: 'center', flexWrap: 'wrap' }}>
                    <div style={{ flex: 1, minWidth: 0, background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: 8, padding: '0.6rem 0.875rem', fontFamily: 'Poppins', fontSize: '0.8rem', color: 'var(--muted2)', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>{link}</div>
